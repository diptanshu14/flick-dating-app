        ...
        <div>
          ...
          <div className="mt-1">
            <input 
              ...
              className='appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:boder-pink-500 sm:text-sm'
            />
          </div>
        </div>
          ...
          <div className="mt-2 flex gap-2">
            <div className="flex items-center">
              <input 
                ...
                className='h-4 w-4 text-pink-600 focus:ring-pink-600 border-gray-300 '
              />
